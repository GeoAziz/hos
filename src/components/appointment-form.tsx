...
export function AppointmentForm() {
  ...
  const [submissionResult, setSubmissionResult] = useState<BookAppointmentOutput | null>(null);
       ...
       {submissionResult && submissionResult.success && (
            <Card className="mt-8 text-left bg-green-50 border-green-200">
                <CardHeader className="flex flex-row items-center gap-3">
                    ...
                    <CardTitle className="text-lg text-green-900">Appointment Request Sent!</CardTitle>
                </CardHeader>
